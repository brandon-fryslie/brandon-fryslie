...
A remastered card is **not** the card that was live — GitHub's search index lags by minutes, so a query for a past 06:03 returns more today than it did then. The reconstruction is more accurate, not more faithful. The stamp, date, and originating commit are unchanged.
